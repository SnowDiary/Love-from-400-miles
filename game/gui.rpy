...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/SourceHanSerifCN-Regular.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/SourceHanSerifCN-Bold.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/SourceHanSerifCN-Regular.ttf"
...
# 初始化资源
image splash = "gui/splash.png" # 1920x1080的启动logo
image splash_caution = "gui/splash_caution.png" # 1920x1080的开头警告
image white_background = "#FFF" # 白色底的背景
...
label splashscreen:
    ...
    scene white_background with dissolve
    with Pause(1)

    show splash_caution with dissolve
    with Pause(3)
